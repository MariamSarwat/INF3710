...
CREATE TABLE IF NOT EXISTS NETFLIXPOLYDB.NominationFilms (
	...
	FOREIGN KEY (num_film) REFERENCES NETFLIXPOLYDB.Film(numero) ON DELETE RESTRICT ON UPDATE CASCADE,
	FOREIGN KEY (id_ceremonie) REFERENCES NETFLIXPOLYDB.Ceremonie(id_ceremonie) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS NETFLIXPOLYDB.Role (
	...
	FOREIGN KEY (id_employee) REFERENCES NETFLIXPOLYDB.Employee(id_employee) ON DELETE RESTRICT ON UPDATE CASCADE,
	FOREIGN KEY (num_film) REFERENCES NETFLIXPOLYDB.Film(numero) ON DELETE RESTRICT ON UPDATE CASCADE
);
